    ...
    switchToPdf.addEventListener('click', () => {
        if (!pdfViewOpened) {
            ...
            _pdftron_pdfjs_express__WEBPACK_IMPORTED_MODULE_5___default()({
                ...
                // https://bestexamhelp.com/exam/cambridge-igcse/${subject}-${subjectCode[subject]}/${year}/${subjectCode[subject]}_${session}${year - 2000}_qp_2${variant}.pdf
                initialDoc: `https://pastpapers.papacambridge.com/download_file.php?files=https://pastpapers.papacambridge.com/directories/CAIE/CAIE-pastpapers/upload/0610_m23_qp_22.pdf` // path to your document
